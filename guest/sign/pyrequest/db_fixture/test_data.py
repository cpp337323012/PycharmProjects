...
datas = {
    ...
    'sign_guest':[
        ...
        {'id':'2', 'realname':'has sign', 'phone':'13511001101', 'email':'sign@mail.com',
         'sign':1, 'event_id':1 },
        {'id':'3', 'realname':'tom', 'phone':'13511001103', 'email':'tom@mail.com',
         'sign':0, 'event_id':5 }  ]
}
...
if __name__ == '__main__':
    init_data()
'''init_data（）传入datas字典中数据，调用DB类中clear()清除表数据，循环调用insert()插入表数据'''
